  ...
  return (
    <div className={cx("flex w-full flex-wrap items-center gap-2", className)}>
      ...
      <div className="flex items-center gap-1.5">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem
                ...
                className={cx(densityValue === "compact" && "bg-(--color-neutral2)")}
              >
              ...
              <DropdownMenuItem
                ...
                className={cx(densityValue === "normal" && "bg-(--color-neutral2)")}
              >
              ...
              <DropdownMenuItem
                ...
                className={cx(densityValue === "comfortable" && "bg-(--color-neutral2)")}
              >
                <Rows3 size={14} className="mr-2" />
                Cómoda
              </DropdownMenuItem>
        ...
        {refresh && (
          <IconButton
            icon={<RefreshCw size={16} className={cx(refreshing && "animate-spin")} />}
