...
const PRODUCTS_DATA = Array.from({ length: 20 }, (_, i) => ({
  id: i + 1,
  name: `Producto ${i + 1}`,
...
export const mockProducts = PRODUCTS_DATA;
...
export const CATEGORIES = [
  ...
  { id: "cat4", name: "Categoría 4" },
  { id: "cat5", name: "Categoría 5" },
  { id: "cat6", name: "Categoría 6" },
];
